 ...
 * the License.
 */
package cn.com.warlock.common.crypt;
...
public class Crypt {
    ...
    private static final int     con_salt[]  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    private static final int     skb[][]     = { {
                                                   ...
                                                   0x20090830, },
                                                 {
                                                   ...
                                                   0x10200404, 0x12200404, 0x10202404,
                                                   0x12202404, },
                                                 {
                                                   ...
                                                   0x09000202, 0x09000203, 0x09040202,
                                                   0x09040203, },
                                                 {
                                                   ...
                                                   0x04121108, },
                                                 {
                                                   ...
                                                   0x20101004, 0x30101004, 0x20111004,
                                                   0x30111004, },
                                                 {
                                                   ...
                                                   0x02020401, 0x0A020401, 0x02020409,
                                                   0x0A020409, },
                                                 {
                                                   ...
                                                   0x01200210, 0x01200310, 0x01280210,
                                                   0x01280310, },
                                                 {
    ...
    private static final int     SPtrans[][] = { {
                                                   ...
                                                   0x80020200, },
                                                 {
                                                   ...
                                                   0x10002004, 0x00000004, 0x10040000,
                                                   0x00042000, },
                                                 {
                                                   /** nibble 2 */
                                                   ...
                                                   0x01010000, },
                                                 {
                                                   ...
                                                   0x00000402, 0x04000000, 0x04000002,
                                                   0x04100400, },
                                                 {
                                                   /** nibble 4 */
                                                   ...
                                                   0x00000008, 0x00004108, 0x02004000,
                                                   0x02000008, },
                                                 {
                                                   /** nibble 5 */
                                                   ...
                                                   0x20080000, 0x00000810, 0x00000010,
                                                   0x20080010, },
                                                 {
                                                   /** nibble 6 */
                                                   ...
                                                   0x00400001, 0x00401080, 0x00401000,
                                                   0x00001001, },
                                                 {
                                                   /** nibble 7 */
                                                   ...
                                                   0x08000000, 0x08200020, 0x00008000,
                                                   0x00208020 } };
    private static final byte    cov_2byte[] = { 0x2E, 0x2F, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35,
    ...
    private static int[] des_set_key(byte key[]) {
        ...
        for (int i = 0; i < ITERATIONS; i++) {
            ...
            t = skb[4][(d) & 0x3f] | skb[5][((d >>> 7) & 0x03) | ((d >>> 8) & 0x3c)]
                | skb[6][(d >>> 15) & 0x3f] | skb[7][((d >>> 21) & 0x0f) | ((d >>> 22) & 0x30)];
    ...
    public static void main(String[] args) throws IOException {
        ...
        byte[] pwd = Crypt.crypt("warlock".getBytes(encoding), password.getBytes(encoding));
