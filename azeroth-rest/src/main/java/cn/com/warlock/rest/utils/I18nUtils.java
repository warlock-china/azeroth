package cn.com.warlock.rest.utils;
...
public class I18nUtils {
            ...
            if (resource.getProtocol().equals("file")) {
                ...
                try {
                    ...
                    jarFilePath = jarFilePath.substring("file:".length(),
                        jarFilePath.length() - "!/i18n/".length());
                    ...
                    while (entries.hasMoreElements()) {
                        ...
                        if (entry.getName().endsWith(".properties")
                            && entry.getName().contains("i18n/")) {
                            String parentPath = entry.getName().substring(0,
                                entry.getName().lastIndexOf("/") + 1);
                            String fileName = entry.getName()
                                .substring(entry.getName().lastIndexOf("/") + 1);
                            String baseName = parentPath + fileName.substring(0,
                                fileName.length() - "_en_US.properties".length());
        ...
        for (File file : files) {
            if (file.isDirectory()) {
                ...
                if (path.endsWith("properties")) {
                    ...
                    String resName = parentPath.replace(classPath, "")
    ...
    public static String getMessage(RequestHeader header, String code, Object[] params,
