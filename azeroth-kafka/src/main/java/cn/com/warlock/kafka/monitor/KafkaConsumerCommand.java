...
import cn.com.warlock.kafka.monitor.model.TopicInfo;
...
public class KafkaConsumerCommand {
    ...
    protected List<String> group() {
        ...
        scala.collection.immutable.List<GroupOverview> list = adminClient
    ...
    public ConsumerGroupInfo consumerGroup(KafkaConsumer<String, Serializable> kafkaConsumer,
        ...
        scala.collection.immutable.List<ConsumerSummary> consumers = adminClient
        ...
        while (iterator.hasNext()) {
            ...
            while (iterator2.hasNext()) {
                ...
                OffsetAndMetadata metadata = kafkaConsumer
                    .committed(new TopicPartition(partition.topic(), partition.partition()));

                TopicPartitionInfo partitionInfo = new TopicPartitionInfo(partition.topic(),
                    partition.partition(), metadata.offset(), owner);
                //
