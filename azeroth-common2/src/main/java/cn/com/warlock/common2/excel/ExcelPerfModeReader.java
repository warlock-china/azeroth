...
import cn.com.warlock.common2.excel.convert.XLS2CSV;
import cn.com.warlock.common2.excel.convert.XLSX2CSV;
...
public class ExcelPerfModeReader {
    ...
    private List<String> readAsXLSX(String path) {
        ...
        try {
            ...
            if (e instanceof OLE2NotOfficeXmlFileException || e instanceof NotOLE2FileException || e instanceof NotOfficeXmlFileException
                    || e instanceof OfficeXmlFileException) {
                throw new ExcelOperBaseException("请选择正确格式excel文件");
            }
            if (e instanceof IOException) {
                throw new ExcelOperBaseException("文件读取失败");
