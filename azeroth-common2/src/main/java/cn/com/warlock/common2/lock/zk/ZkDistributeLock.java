package cn.com.warlock.common2.lock.zk;
...
import cn.com.warlock.common2.lock.LockException;
...
public class ZkDistributeLock implements Lock, Watcher {
    ...
    public boolean tryLock() {
        try {
            // 创建临时子节点
            myZnode = zk.create(ROOT_PATH + "/" + lockName + LOCK_KEY_SUFFIX, new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE,
